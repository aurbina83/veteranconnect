        ...
        var EventDetailController = (function () {
            function EventDetailController(EventService, ErrorService, UserService, CommentService, $state, $stateParams) {
                ...
                EventService.getOne($stateParams['id']).then(function (res) {
                    ...
                    _this.socket = io("http://veteranconnect.co", { port: 3000 });
                    _this.socket.emit('join', { event: _this.event._id });
                }, function (err) {
                ...
                this.socket.on('receive', function (data) {
                    _this.event.comments.push(data);
                });
            }
            EventDetailController.prototype.socketM = function () {
                var name = this.status.name.split(' ');
                var date = new Date();
                var message = {
...
//# sourceMappingURL=data:application/json;base64,
var app;
(function (app) {
    var Controllers;
    (function (Controllers) {
...
//# sourceMappingURL=data:application/json;base64,
